...
function TeacherSignup() {
    ...
    // To validate the teachersignup form
    const validateForm = () => {
        const newErrors = {};
    ...
    const handleSubmit = async (e) => { // (e) is the event
        ...
        try {
            ...
            const response = await fetch('http://localhost:5000/teacher/register', { // http path form register page
            ...
            // if condition is used for login successfully to navigate the teacherlogin page  
            if (response.ok) {
    ...
    const handleLoginClick = () => {
        navigate('/teacherlogin');
    }; // handleLoginClick function closed

    // HTML code
    return (
        // teachersignup page container
        <div className="teachersignup-container">
            <h2>Teacher Signup</h2>

            {/* teachersignup page form */}
            <form className="teachersignup-form" onSubmit={handleSubmit}> {/* onSubmit is used for form is submit that time to call the handleSubmit function */}
                ...
                /> {/* input field for password closed */}
                ...
                {/* To type the name,email,password this data's are already store in myteacherCollection database will display the You already have an account. */}
            ...
            </form> {/* teachersignup page form closed tag */}
        </div> // teachersignup page container closed div
    );
}

// Export the TeacherSignup function
